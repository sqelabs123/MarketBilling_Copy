...
public class billrun_with_Import_Meter_and_Meter_Register extends Login_site{
	...
	public void Import_Meter_Register() throws Exception{
		...
		Thread.sleep(1000);
		 ...
		 String p=System.getProperty("user.dir")+"//TestData//Register Import Template.csv";
			...
			String serviceId= "N478535832";

			String meterNo= "mfrdtrte23";

	        csv_file.ImportMeterRegister(p, col, serviceId, meterNo,"1", "NA", "KWH","ALLDAY", "1", "5", "11", "No","Current","Cumulative", "0","0", prodate, "");
